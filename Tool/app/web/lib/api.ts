...
export type ScheduleDetail = { key: string; lines: (Line & { business_meaning: string; computation: string; display?: string; derived?: boolean; kind?: string; emphasis?: boolean })[]; totals: Record<string, number>; values: Record<string, number>; available: boolean; distribution_band?: string; max_dividend_payout?: string };
